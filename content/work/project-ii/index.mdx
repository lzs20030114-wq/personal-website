...
<InteractiveSlot id="FIG.02" caption="Four morphologies from one contraction degree of freedom — the structural engine behind the net, running live" status="可现产" size="wide">
  <SkinSolidFigure />
</InteractiveSlot>
