...
- **触手 spec v0.1 写就（2026-07-10）**：用户提出做触手，按第二梯队纪律先出 spec（轮回机器_触手spec.md）——方案阶梯 A+（零红线玩具）/ B+C（软约束+Verlet 动力学，踩 §1.2 红线需门控解锁，≈1.5 session，排 M3 后）。**待拍板，批准前原「不做」决策有效，不写代码。**
