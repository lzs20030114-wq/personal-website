      ...
      <div className="shell pg-dark" data-pt-content>
        ...
        <Bench
          ...
          specs={[
            ...
            ['Pinched box', '76 px high — two 22 px shelves with a 32 px gap · seam cuts to the mast'],
            ['Deeper gap', 'A taller box needs more slack, and slack has a ceiling — so the square grows: side 167 px'],
            ['Its cost', 'The band is spent to the last node, so this plan hangs 13 px lower than the flat one'],
