...
const LABS = [
  ...
  },
  {
    kicker: 'Lab 2-11',
    title: 'Compositions',
    body: 'Units of different forms in a row — a passage, a shared platform, an enclosure — every slot swappable, spacing measured.',
    meta: '5 forms · 3 compositions · WebGL',
    href: '/lab#lab2-11',
    bar: 'var(--p700)',
    hover: 'var(--p100)',
    kickerColor: 'var(--accent-2)',
...
// 统计条（MAPPING §4：当前实测测试数，硬编码，发版时人工更新——2026-09-17 vitest 实测 548；
// 迭代稿配色：Tests=绿 700、Kernels=紫 700、Demos=绿 600）
const STATS = [
  { n: '04', label: 'Projects', color: 'var(--ink)' },
  { n: '548', label: 'Tests green', color: 'var(--accent)' },
