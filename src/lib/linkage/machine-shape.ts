...
export const ARM_PLACEMENT: ArmPlacement = {"origin": [-209.5154, 107.4418, -46.8738], "rollDeg": 2.577};
...
export const SMALLARM_PLACEMENTS: ReadonlyArray<SmallArmPlacement> = [{"o": [-120.5254, -157.066, -42.834], "axis": [-0.0, 1.0, 0.0], "h": [-1.0, 0.0, 0.0]}, {"o": [49.4748, 156.8959, -42.834], "axis": [-0.0, -1.0, 0.0], "h": [1.0, 0.0, 0.0]}];
...
export const MACHINE_TRIS = 83500;
